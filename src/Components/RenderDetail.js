...
export default function RenderDetail(props) {
    ...
    return (
        <div className='mt-4'>
            <p className='row'>Does the Kitchen team consistently execute Finney’s standards on the following items throughout the two (2) day audit...</p>
            ...
            <Container className='d-flex justify-content-between mt-4 align-items-center'>
                <h4>Quality Control Part III: Attention To Detail (12 points)</h4>
                <h4>{checked()} / 12</h4><h4> {Math.round(checked() / 12 * 100)}%</h4>
            </Container>
        </div>
    )
